	...
	<form class="conveythis-widget-option-form" style="max-width: 60%; min-width: 1024px; position: relative;" method="post" action="options.php">
		...
		<div id="customize-tab" style="display: none">
            ...
            <div style="margin: 10px 0 28px 0; width: 550px;">
                ...
                <input type="hidden" name="target_languages_translations" value='<?php echo json_encode( $this->target_languages_translations ); ?>'>
            </div>
            ...
            <div style="margin: 10px 0 60px 0; width: 550px;">
                ...
                <div style="margin-left: 300px;">
                    ...
                    <br>
                    <?php if(!empty($this->translate_links) && $this->translate_links == 1): ?>
                        <div dir="ltr">
...
<?php
	...
	wp_enqueue_style('conveythis-settings', plugins_url('css/settings.css?v=4',__FILE__) );
