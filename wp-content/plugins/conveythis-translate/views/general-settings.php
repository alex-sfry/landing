    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="form-group">
                ...
                <div class="radio-block">
                    <div class="form-check paid-function">
                        <input type="radio" class="form-check-input me-2" id="auto_translate_yes" name="auto_translate" value="1" <?php echo $this->auto_translate == 1 ? 'checked' : '' ?>>
                        <label for="auto_translate_yes">Yes</label></div>
                    <div class="form-check">
                        <input type="radio" class="form-check-input me-2" id="auto_translate_no" name="auto_translate" value="0" <?php echo $this->auto_translate == 0 ? 'checked' : '' ?>>
            ...
            <div class="form-group">
                ...
                <div class="radio-block">
                    <div class="form-check">
                        <input type="radio" class="form-check-input me-2" id="translate_media_yes" name="translate_media" value="1" <?php echo $this->translate_media == 1 ? 'checked' : ''?>>
                        <label for="translate_media_yes">Yes</label></div>
                    <div class="form-check">
                        <input type="radio" class="form-check-input me-2" id="translate_media_no" name="translate_media" value="0" <?php echo $this->translate_media == 0 ? 'checked' : ''?>>
            ...
            <div class="form-group">
                ...
                <div class="radio-block">
                    <div class="form-check">
                        <input type="radio" class="form-check-input me-2" id="translate_document_yes" name="translate_document" value="1" <?php echo $this->translate_document == 1 ? 'checked' : ''?>>
                        <label for="translate_document_yes">Yes</label></div>
                    <div class="form-check">
                        <input type="radio" class="form-check-input me-2" id="translate_document_no" name="translate_document" value="0" <?php echo $this->translate_document == 0 ? 'checked' : ''?>>
            ...
            <div class="form-group">
                ...
                <div class="radio-block">
                    <div class="form-check">
                        <input type="radio" class="form-check-input me-2" id="translate_links_yes" name="translate_links" value="1" <?php echo $this->translate_links == 1 ? 'checked' : ''?>>
                        <label for="translate_links_yes">Yes</label></div>
                    <div class="form-check">
                        <input type="radio" class="form-check-input me-2" id="translate_links_no" name="translate_links" value="0" <?php echo $this->translate_links == 0 ? 'checked' : ''?>>
            ...
            <div class="form-group mb-4">
                ...
                <div class="radio-block">
                    <div class="form-check">
                        <input type="radio" class="form-check-input me-2" id="change_direction_yes" name="change_direction" value="1" <?php echo $this->change_direction == 1 ? 'checked' : ''?>>
                        <label for="change_direction_yes">Yes</label></div>
                    <div class="form-check">
                        <input type="radio" class="form-check-input me-2" id="change_direction_no" name="change_direction" value="0" <?php echo $this->change_direction == 0 ? 'checked' : ''?>>
            ...
            <div class="form-group">
                ...
                <div>
                    <div class="form-check">
                        <input type="radio" class="form-check-input me-2" name="url_structure" id="regular" value="regular"  <?php echo $this->url_structure == 'regular' ? 'checked' : ''?>>
                        <label for="regular">Sub-directory (e.g. https://example.com/es/)</label></div>
                    <div class="form-check">
                        <input type="radio" class="form-check-input me-2" name="url_structure" id="subdomain" value="subdomain" <?php echo $this->url_structure == 'subdomain' ? 'checked' : ''?>>
                        <label for="subdomain">Sub-domain (e.g. https://es.example.com) (Beta)</label></div>
                </div>
                <div id="dns-setup" <?php echo  ($this->url_structure == 'subdomain') ? 'style="display:block"' : '' ?> >
                    <div class="card">
                        <td class="card-body">
            ...
            <div class="form-group">
                ...
                <div class="ui fluid search selection dropdown">
                    <input type="hidden" name="default_language" value="<?php echo  esc_html($this->default_language); ?>">
            ...
            <div class="form-group mb-4">
                ...
                <div class="form-check">
                    <input type="checkbox" class="form-check-input me-2" id="hreflang_tags" name="alternate" value="1" <?php checked( 1, $this->alternate, true ); ?>>
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input type="checkbox" class="form-check-input me-2" id="selectbox" name="show_javascript" value="1"  <?php checked( 1, $this->show_javascript, true ); ?>>
