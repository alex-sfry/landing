    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="form-group" id="apiKey">
                ...
                <div class="ui input w-100">
                    <input type="text" name="api_key" id="conveythis_api_key" class="conveythis-input-text text-truncate" value="<?php echo  esc_attr( $this->api_key ); ?>" placeholder="pub_XXXXXXXXXXXXXXXX" />
            ...
            <div class="form-group" id="sourceLanguage">
                ...
                <div class="ui dropdown fluid search selection widget-trigger">
        ...
        <div class="col-md-4" style="display: flex; align-items: center; justify-content: center;" id="widget-preview-general">
            <div class="widget-preview">
                ...
                <div dir="ltr" style="margin: 0; padding: 10px 10px 10px 15px; height: 60px; border: none; border-top: 1px solid rgba(34,36,38,.1);">
