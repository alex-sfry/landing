                    ...
                    <div class="register-form" id="register-div">
                        <form id="register_form" method="post" style="" autocomplete="off">
                            <div class="d-flex reg-input">
                                <input class="style-input" name="email" type="email" placeholder="Email Address" required="" autocomplete="new-password">
                            </div>
                            ...
                            <button class="style-btn" type="submit">Register Now</button>
                        </form>
                    </div>
                </div>
                <div class="img-block"><img src="<?php echo CONVEY_PLUGIN_DIR.'/images/img-rocket.jpg' ?>" alt="ConveyThis"></div>
            </div>
        </div>
    </div>
</div>
